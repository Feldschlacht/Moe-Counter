...
function getCountImage(params) {
  // Added 'render' parameter with default 'auto'
  let { count, theme = 'moebooru', padding = 7, prefix = -1, offset = 0, align = 'top', scale = 1, pixelated = '1', darkmode = 'auto', render = 'auto' } = params
